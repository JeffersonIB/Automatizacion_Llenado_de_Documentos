<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.Master" AutoEventWireup="true" CodeBehind="Fincas.aspx.cs" Inherits="RRHH5.Pages.Admin.Fincas" %>
                        ...
                        <asp:GridView ID="gvFincas" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Eliminar">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnEliminar" runat="server" ImageUrl="~/Pages/Img/Elimina.png" CommandName='ShowModalEl' CommandArgument='<%#Eval("Id_Finca") %>' style="display: block; margin: 0 auto;" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
