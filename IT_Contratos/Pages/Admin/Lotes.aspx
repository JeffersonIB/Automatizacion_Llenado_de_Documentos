<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.Master" AutoEventWireup="true" CodeBehind="Lotes.aspx.cs" Inherits="RRHH5.Pages.Admin.Lotes" %>
                                ...
                                <asp:GridView ID="gvLotes" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Eliminar">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEliminar" runat="server" ImageUrl="~/Pages/Img/Elimina.png" CommandName="ShowModalEl" CommandArgument='<%#Eval("Id_Lote") %>' style="display: block; margin: 0 auto;"  />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
