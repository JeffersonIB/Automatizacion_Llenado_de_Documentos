<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.Master" AutoEventWireup="true" CodeBehind="Procesos.aspx.cs" Inherits="RRHH5.Pages.Admin.Procesos" %>
                        ...
                        <asp:GridView ID="gvProcesos" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Eliminar">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnEliminar" runat="server" ImageUrl="~/Pages/Img/Elimina.png" CommandName="ShowModalEl" CommandArgument='<%#Eval("Id_Proceso") %>' style="display: block; margin: 0 auto;"/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
