<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.Master" AutoEventWireup="true" CodeBehind="Registros.aspx.cs" Inherits="RRHH5.Pages.Admin.Registros" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body1" runat="server">
    ...
    <body>
        <div class="container box">
            <center>
                <h1 class="title">Administración de registros
                </h1>
            </center>
        </div>
        <!-- Modal Actualizar -->
                        ...
                        <asp:GridView ID="gvRegistros" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Eliminar">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnEliminar" runat="server" ImageUrl="~/Pages/Img/Elimina.png" CommandName='ShowModalEl' CommandArgument='<%#Eval("Id_Registro") %>' style="display: block; margin: 0 auto;" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
