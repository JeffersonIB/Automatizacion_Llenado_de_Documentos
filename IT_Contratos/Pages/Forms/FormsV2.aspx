<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.Master" AutoEventWireup="true" CodeBehind="FormsV2.aspx.cs" Inherits="RRHH5.Pages.Forms.FormsV2" %>
                                ...
                                <tr>
                                    <td>
                                        <div class="scroll_checkboxes" cssclass="form-control">
                                            <asp:CheckBox ID="selectAll" runat="server" Text="SelectAll" onclick="SelectAll(this.id)" />
