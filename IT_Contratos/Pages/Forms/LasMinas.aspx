<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.Master" AutoEventWireup="true" CodeBehind="LasMinas.aspx.cs" Inherits="RRHH5.Pages.Forms.LasMinas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body1" runat="server">
    ...
    <body>
        <div class="container box">
            <center>
                <h1 class="title">Finca Las Minas
                </h1>
            </center>
        </div>
