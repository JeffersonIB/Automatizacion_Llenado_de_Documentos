<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.Master" AutoEventWireup="true" CodeBehind="LasVegas.aspx.cs" Inherits="RRHH5.Pages.Forms.LasVegas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body1" runat="server">
    ...
    <body>
        <div class="container box">
            <center>
                <h1 class="title">Finca Las Vegas
                </h1>
            </center>
        </div>
