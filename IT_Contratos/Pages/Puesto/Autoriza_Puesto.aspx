<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.Master" AutoEventWireup="true" CodeBehind="Autoriza_Puesto.aspx.cs" Inherits="RRHH5.Pages.Puesto.Autoriza_Puesto" %>
                ...
                <div class="modal-body">
                    <table align="center" Style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="collapse" id="collapse6">
                                    <asp:Button ID="btnAutorizar_n" runat="server" class="btn btn-round btn-success" OnClick="btnAutorizar_n_Click" Text="Autorizar" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <asp:Button runat="server" ID="Autorizar_Todo" class="btn btn-round btn-success" OnClick="AutorizarTodo_Click"  Text="Autorizar todo" />
                            </td>
                        </tr>
                    </table>
                </div>
