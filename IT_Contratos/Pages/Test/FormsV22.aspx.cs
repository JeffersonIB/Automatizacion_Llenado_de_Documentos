...
{
    public partial class FormsV22 : System.Web.UI.Page
    {
        //int IdFinca = 0;
        //int IdEmpresa = 0;
        ...
        protected void AgregarEmpleados_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in GridViewCalificaciones.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    //ddlTipo_Actividad.SelectedIndexChanged += ddlTipo_Actividad_OnSelectedIndexChanged;
        ...
        protected void ButtonInsertar_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["conexion"].ConnectionString))
            {
                ...
                foreach (DataRow row in dataTable.Rows)
                {
                    ...
                    string Cantidad = ((TextBox)GridViewCalificaciones.Rows[row.Table.Rows.IndexOf(row)].FindControl("txtCantidad1")).Text;
                    if (ddlLotes != null)
                    {
