<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="FormularioV1.aspx.cs" Inherits="RRHH5.Pages.Test.Moda_DDL_Sin_Recargar" %>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <img src="<%= ResolveClientUrl("~/IMG/Logo.png") %>" alt="">
                        </div>
                    </div>
                    <div class="col-sm-8">
