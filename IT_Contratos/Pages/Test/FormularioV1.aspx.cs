...
{
    public partial class Moda_DDL_Sin_Recargar : System.Web.UI.Page
    {
        ...
        void CargarEmpleados(long IdFinca)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("SP_FNC00200", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        {
            CargarFincas();
            CargarEmpleados(long.Parse(ddlFinca.SelectedValue));
            CargarLotes(long.Parse(ddlFinca.SelectedValue));
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("SP_AG_FNC00600", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add("@Id_Finca", System.Data.SqlDbType.Int).Value = ddlFinca.Text;
