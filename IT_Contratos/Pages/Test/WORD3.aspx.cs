    ...
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                SqlCommand employeeCmd = new SqlCommand("SELECT Nombre_Completo, Edad, Txt_Edad, Sexo, Estado_Civil, Direccion, Sueldo,Txt_Sueldo,Entero,Txt_Entero,Decimal,Txt_Decimal,   Proceso, Puesto, Descriptor, DPI, Primeros, Txt_Primeros, Centro, Txt_Centro, Ultimos, Txt_Ultimos, Provecion_Oficio FROM VW_RCH00701_7 WHERE  ' ' + UPPER(RTRIM(Id_Empleado)+' - '+RTRIM(Nombre_Completo)) = @Id_Empleado ", con);
