<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.Master" AutoEventWireup="true" CodeBehind="Word.aspx.cs" Inherits="RRHH5.Pages.Test.Word" %>
                ...
                <div class="modal-body">
                    ...
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="NombreArchivo" CssClass="form-control" MaxLength="200" Style="width: auto;"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div>
                                    <asp:Button ID="btnWord" runat="server" class="btn btn-round btn-success" Text="Exportar a Word" OnClick="btnWord_Click" />
                                </div>
                            </td>
                        </tr>
                    </table>
